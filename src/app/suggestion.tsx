...
const styles = StyleSheet.create({
  ...
  typeText: { color: palette.textSecondary, fontSize: 12, fontWeight: '800' },
  ...
  formDescription: { marginTop: 4, color: palette.textSecondary, fontSize: 12, lineHeight: 17 },
  ...
  count: { marginTop: 6, color: palette.textMuted, textAlign: 'right', fontSize: 11 },
  error: { marginTop: 8, color: '#FF8E8E', fontSize: 12, lineHeight: 17 },
  ...
  submitText: { color: palette.accentText, fontSize: 15, fontWeight: '900' },
  ...
  doneDescription: { marginTop: 5, color: palette.textSecondary, fontSize: 13 },
  ...
  doneButtonText: { color: palette.text, fontSize: 14, fontWeight: '800' },
